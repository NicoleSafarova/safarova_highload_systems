...
```
12 500 000 активных пользователей × 12 запросов за сеанс = 150 000 000 запросов/день
```
...
| Поиск и просмотр ленты | 150 000 000 * 0.3 / 86400 сек  | 520 | 2600 |
| Добавление в корзину | 12 500 000 * 5 / 86400 сек  | 723 | 3616 |
| Оформление заказа | 4 500 000  / 86400 сек  | 52 | 260 |
| Авторизация | 12 500 000 / 86400 сек  | 145 | 723 |
| Регистрация | 1 300 000 / 86400 сек  | 15 | 75 |
| Отзывы и вопросы | 12 500 000 * 0.05 / 86400 сек  | 7 | 35 |
| Загрузка изображений | 50 * 12 500 000 * 0.01 / 86400 сек  | 72 | 361 |
| Изменение данных в профиле или добавление адреса пункта выдачи | 12 500 000 * 0.1 / 86400 сек  | 14 | 72 |
| Сумма | -  | 2243 | 11217 |
