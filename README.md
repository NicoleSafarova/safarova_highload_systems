...
| Микросервисы | Пользователи, товары, склады | Удобное распределение запросов по типам|
