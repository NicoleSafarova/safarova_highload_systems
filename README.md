...
2) Нет перегрузки одного дата-центра (2/3 нагрузки буде на москвоский ДЦ)

3) Так как Москва и Санкт-Петербург располагаются рядом, то при отказе пользователя быстро напрявят на другой ДЦ 
